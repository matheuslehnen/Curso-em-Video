...
<div id="interface">
    ...
    <section id="corpo">
        <div id="fundo">
            ...
            <form action="main.php" method="post" id="formularioEditaCliente">
                <fieldset class="fs">
                    <legend>Edite o cliente </legend>
                    <label for="fID">ID: <input type="number" id="fID" name="fID" min="1" max="100" placeholder="ID que deseja editar"></label><br>
                    ...
                    <input id="botaoEditaCliente" name="botaoEditaCliente" class="botoes" type="submit">
                </fieldset>
            </form>
        </div>
    </section>
