...
<main>
    ...
    <section id="corpo">
        <div id="fundo">
            ...
            <form action="Recepcionista.php" method="post" id="formularioCadastro">
                <fieldset class="fs">
                    ...
                    <label for="fNascimento">Nascimento: <input type="text" id="fNascimento" name="fNascimento" placeholder="Data de Nascimento"></label><br>
                        ...
                        <label for="fUF">UF:</label>
                            ...
                            <input id="botaoCadastroCliente" name="botaoCadastroCliente" class="botoesRecepcao" type="submit">
                </fieldset>
            </form>
        </div>
    </section>
